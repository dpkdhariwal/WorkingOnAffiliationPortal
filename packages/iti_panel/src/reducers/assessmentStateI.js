...
// 2. Falls Under Hill Area/Hill?[single]
// 3. Falls Under Border District?[single]
// 4. Trade/Unit[single][multiple]
// 5. Land Documents*[multiple]
// 6. Lease Documents*[multiple]
// 7. Land Area[single]
// 8. ID Proof of Authorized Signatory
// 9. Registration Certificate of Applicant Organization
// 10. ID Proof of Secretary/Chairperson/President
// 11. Resolution Information

//@dpkdhariwal
// Name of the Institute
let nameOfTheInstitute_initialValues = {
  as_per_norms: "No",
  selected_reason: null,
  specified_reason: null,
};
export const nameOfTheInstitute_reducer = (
  state = nameOfTheInstitute_initialValues,
  action
) => {

    ...
    <Fragment>
      <Form>
            ...
            <div className="d-flex align-items-center gap-2">
              ...
              {label.metaInfo.i != "" && (
                <i
                  ...
                  style={{ cursor: "pointer", color: "#6c757d" }}
                  title={label.metaInfo.i}
                  onClick={() => alert(`Info about ${label.metaInfo.i}`)} // Replace with your actual logic
                ></i>
              )}
            </div>
        ...
        <Row className="mb-3">
          <Form.Group as={Col} md="4" controlId="validationCustom01">
            <Form.Label>
              Name of Applicant Entity <span style={{ color: "red" }}>*</span>
              <i
                className="fe fe-help-circle"
                style={{ cursor: "pointer", color: "#6c757d" }}
                title="An individual or entity that submits an application to the DGT for affiliation related purposes, including the establishment of a new Industrial Training Institute (ITI), addition of trades or units in an existing ITI, shifting or relocation of an existing institute, renewal of affiliation, surrender of trades or units in an existing ITI, or any other process as specified under these Norms"
          ...
          <Col md={12}>
            <Row className="mb-3">
              <Form.Group as={Col} md="3" controlId="validationCustom02">
                ...
                <Form.Control as="select" required name="state_of_other_iti">
                  <option value="" selected>
                    Select State
                  </option>
                  <option value="Andhra Pradesh">Andhra Pradesh</option>
              ...
              <Form.Group as={Col} md="3" controlId="validationCustom02">
                ...
                <Form.Control as="select" required name="district_of_other_iti">
                  <option value="" selected>
                    District
                  </option>
                  {/* <option value="Delhi">Delhi</option>
        ...
        <Row className="mb-3">
          <Form.Group as={Col} md="6" controlId="validationCustom02">
            <Form.Label>
              Applicant Entity Email Id <span style={{ color: "red" }}>*</span>
            </Form.Label>

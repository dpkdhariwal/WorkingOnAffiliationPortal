...
export const LandDocuments = ({ steps, step, view: viewProp = false, isView = false, nav }) => {
  ...
  return (
    <Formik innerRef={formRef}
      enableReinitialize
      initialValues={C.st1Asmt.LandDocuments.intiValues}
      validationSchema={C.st1Asmt.LandDocuments.ValSchema}
      onSubmit={(values) => { console.log(values); }} >
      {({ handleSubmit, handleChange, values, errors, touched, }) => {
        return (
          <FormContext.Provider value={{ handleSubmit, handleChange, values, errors, touched, registerForm, unregisterForm }}>

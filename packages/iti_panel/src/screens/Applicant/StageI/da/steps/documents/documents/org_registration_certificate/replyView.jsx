...
export const OrgCertItiRepliedView = ({ data }) => {
        ...
        <>
            ...
            <Card className="bg-body-tertiary border border-2 border-danger card custom-card shadow-danger shadow-size-small">
                <Card.Header className="d-flex justify-content-between">
                    <Modal.Title as="h6">New Registration Certificate of Applicant Organziation</Modal.Title>
                    <Button onClick={() => { cleareForresubmit() }} variant="outline-warning" size="sm">Re-Submit</Button>
                </Card.Header>
                <Card.Body>
                    <Button variant="success" onClick={() => {viewFile(data?.latest_certificate?.document);}} className="btn-block" size="lg" >View New Uploaded Registration Certificate of Applicant Organziation </Button>
                </Card.Body>
            </Card>
        </>
    );

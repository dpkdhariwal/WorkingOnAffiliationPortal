...
export const ResolutionRegardingEarmarkingOfLandBuildingAndOtherResourcesExclusivelyDedicatedToTheITI = ({ step, view: viewProp = false, isView = false }) => {
    ...
    <>
      <Card className="custom-card shadow" style={{ marginTop: '10px', padding: '0px', padddingBlockStart: '0px !importent' }}>
        <Card.Header className="d-flex justify-content-between mb-3 bg bg-danger-gradient">
          <div className="p-2">
            <h5>Resolution Regarding Earmarking of Land, Building, and other Resources Exclusively Dedicated to the ITI</h5>
          </div>
                  ...
                  <Form noValidate onSubmit={handleSubmit}>
                    <Card className="custom-card border border-primary">
                      <Card.Body>
                        <BootstrapForm.Group>
                          <Form.Label>
                            Select Resolution Regarding Earmarking of Land, Building, and other Resources Exclusively Dedicated to the ITI (if any), as per the Format Provided in Annexure-5.

...
import { ItiResolutionCertificate } from "./iti_resolution_certificate/replyView";
import { formatedDate } from "@/helpers";

export const ResolutionForStartingITI = ({ data, step, view: viewProp = false, isView = false }) => {
  ...
  return (
    <>
      ...
      {data?.da_status == C.SL.REPLIED ? (<ItiResolutionCertificate data={data} />) : (<Formik
        enableReinitialize={true}
        innerRef={formikRef}
        initialValues={st1documentuploads.intiValuesResolutionForStartingITI}
        validationSchema={st1documentuploads.valSchemaResolutionForStartingITI}
      >

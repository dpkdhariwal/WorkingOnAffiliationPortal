      ...
      {data?.da_status == C.SL.REPLIED ? (
        ...
        <Card className="bg-body-tertiary border border-2 border-danger card custom-card shadow-danger shadow-size-small">
          <Card.Header className="d-flex justify-content-between">
            <Modal.Title as="h6">New ID Proof of Secretary/Chairperson/President</Modal.Title>
            ...
            >
              <thead>
                <tr>
                  ...
                  <th>Select ID Proof Type</th>
                  <th>Enter ID Proof Number</th>
                  <th> Uploaded Document</th>
                </tr>
              </thead>
              <tbody>
                {data.latest_scp.map((item, index) => {
                  return (
                    <tr key={index}>
                      {/* <td>{index++}</td> */}
                      ...
                      <td><Button size="md" variant="success" onClick={() => {viewFile(item?.document)}} >View Uploaded Document</Button></td>
                    </tr>)
                })}

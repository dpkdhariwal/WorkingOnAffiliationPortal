...
import { AsessementIActions, Navigations } from "@/components/Assessment/components";
import SwalManager from "@/common/SwalManager";

import { LandDocuments } from "./LandDocuments/LandDocuments";
import { OtherDocuments } from "./OtherDocuments/OtherDocuments";
import { EntityDetails } from "./BasicDetails/BasicDetails";
import { DetailsP } from "./DetailsOfTheProposedInstitute/DetailsOfTheProposedInstitute";
import { TradeUnitsView } from "./TradeUnites/TradeUnits";
    ...
    try {
      switch (step.step) {
        ...
        case ST1FC.DETAILS_OF_THE_PROPOSED_INSTITUTE.step:
          return <DetailsP step={step} nav={object(step, stepIndex)} />;
        case ST1FC.DETAILS_OF_TRADE_UNIT_FOR_AFFILIATION.step:
          return <TradeUnitsView step={step} nav={object(step, stepIndex)} />;

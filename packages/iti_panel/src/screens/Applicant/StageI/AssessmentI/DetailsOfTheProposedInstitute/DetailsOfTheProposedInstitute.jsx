...
import DetailsOfTheProposedInstitute from "@/screens/state/assessor/AssessmentI/DetailsOfTheProposedInstitute/views/DetailsOfTheProposedInstitute";



export const DetailsP = ({ steps, step, view: viewProp = false, isView = false, nav }) => {
    ...
    return (
        <>
            <DetailsOfTheProposedInstitute appId={appId} />

...
import ITLAB from "@/screens/state/assessor/AssessmentII/Tradewise Machinery Tools Equipment Details/views/ITLAB"
import TRADEMTE from "@/screens/state/assessor/AssessmentII/Tradewise Machinery Tools Equipment Details/views/TradeMTE";
  ...
  const loadData = async () => {
    try {
      ...
      Object.entries(resp.data).forEach(([key, value]) => {
        ...
        switch (key) {
          case 'itLab':
            addItem({ row: value, title: "Workshop Assessment", comp: <ITLAB title={key} info={value} /> });
            break;
    ...
    <Card className="custom-card border border-success">
      ...
      <Card.Body>
        <Formik
          ...
          context={{ usertype: usertype }} // Pass context here, including usertype
        >

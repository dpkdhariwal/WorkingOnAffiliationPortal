...
import { BuildingPlan_asmt } from "@/screens/state/assessor/AssessmentII/Building Detail/BuildingPlan";
import { BccAsmt } from "@/screens/state/assessor/AssessmentII/Building Detail/BCC";
import { PhotosOfBuilding } from "@/screens/state/assessor/AssessmentII/Building Detail/PhotosOfBuilding";
...
export const BuildingDetailAssessment = ({ step, nav }) => {
  ...
  const loadData = async () => {
    ...
    try {
      ...
      // ✅ Wait for API to finish
      const resp = await st.getBasicDetail_asmt(appId, step.assessment_id);
      console.log(resp.data);

...
import LandDocumentsVerification from "./views/LandDocuments";
import LeaseDocumentsVerification from "./views/LeaseDocuments";
import LandAreaVerification from "./views/LandArea";

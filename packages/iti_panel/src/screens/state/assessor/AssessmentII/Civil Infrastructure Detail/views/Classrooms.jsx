...
import { ViewAreaClassroom } from "@/components/Assessment/ViewAreaClassroom";
                        ...
                        <Col xl={6} lg={6} md={6} sm={6}>
                            {values.usertype === C.SL.ASSESSOR && (
                                <Card ref={divRef} className="border border-2  card custom-card  card">
                                    <Card.Body>
                                        {values.CLASSROOMS.replied === false && (
                                            <ViewAreaClassroom info={info} />)
                                            }
                            ...
                            {values.CLASSROOMS.as_per_norms == C.SL.NO && values.usertype === C.SL.APPLICANT && (<Card ref={divRef} className="border border-2  card custom-card  card">
                                <Card.Body>
                                    <RevisedInputArea
                                                                                required_area_fieldname={`REVISED_CLASSROOMS.avaialble_area`}
                                                                                document_field={`REVISED_CLASSROOMS.document`}

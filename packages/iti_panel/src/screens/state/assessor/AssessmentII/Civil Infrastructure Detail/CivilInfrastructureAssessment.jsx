...
import MULTIPURPOSE_HALL_asmt from "./views/MULTIPURPOSE_HALL_asmt";
import LIBRARY_asmt from "./views/LIBRARY_asmt";
import IT_LAB_asmt from "./views/IT_LAB_asmt";
import PLACEMENT_AND_COUNSELLING_ROOM_asmt from "./views/PLACEMENT_AND_COUNSELLING_ROOM_asmt";
import PRINCIPAL_ROOM_asmtfrom from "./views/PRINCIPAL_ROOM_asmt";
import RECEPTION_CUM_WAITING_LOBBY_asmt from "./views/RECEPTION_CUM_WAITING_LOBBY_asmt";
import STAFF_ROOM_asmt from "./views/STAFF_ROOM_asmt";
import ADMINISTRATIVE_HALL_SECTION_asmt from "./views/ADMINISTRATIVE_HALL_SECTION_asmt";

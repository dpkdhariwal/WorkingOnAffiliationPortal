                    ...
                    <Row style={{
                        ...
                        <Col xl={6} lg={6} md={6} sm={6}>
                            {values.usertype === C.SL.ASSESSOR && (<Card ref={divRef} className="border border-2  card custom-card  card">
                                <Card.Body>
                                    {console.log(info)}
                                    {values.RECEPTION_CUM.replied === false && (<ViewArea required_area={info?.initial_detail?.required_area} totalAvailableArea={info?.initial_detail?.totalAvailableArea} document={info?.initial_detail?.document} />)}

                                    {values.RECEPTION_CUM.replied === true && ('Show Latest')}

                                    {console.log(info)}
                                </Card.Body>
                            </Card>)}

                            {values.RECEPTION_CUM.as_per_norms == C.SL.NO && values.usertype === C.SL.APPLICANT && (<Card ref={divRef} className="border border-2  card custom-card  card">
                                <Card.Body>
                                    <RevisedInputArea
                                        particular="RECEPTION_CUM"
                                        required_area={values?.RECEPTION_CUM?.initial_detail?.required_area}
                                        required_area_fieldname={`REVISED_RECEPTION_CUM.avaialble_area`}
                                        document_field={`REVISED_RECEPTION_CUM.document`}
                        ...
                        <Col xl={6} lg={6} md={6} sm={6}>
                            ...
                            {values.usertype === C.SL.APPLICANT
                                && values.RECEPTION_CUM?.as_per_norms === "no" &&
                                (<ViewStateRemark title={`RECEPTION_CUM`}
                                    as_per_norms={values.RECEPTION_CUM?.as_per_norms}
                                    reason={values.RECEPTION_CUM?.reason}
                                    assessor_remark={values.RECEPTION_CUM?.assessor_remark} />)}
                                ...
                                <Card.Body>
                                        ...
                                        <Form.Group>
                                            ...
                                            <div role="group" aria-labelledby="as_per_norms-group">
                                                <label className="me-3">
                                                    <Field
                                                        type="radio"
                                                        name="RECEPTION_CUM.as_per_norms"
                                                        value="yes"
                                    ...
                                    {values.RECEPTION_CUM.as_per_norms === "no" && (
                                        <Row className="mb-3">
                                            ...
                                            {values.RECEPTION_CUM.reason === "other" && (
                                                <Form.Group as={Col} md="12" style={{ marginTop: "1rem" }}>
                                                    ...
                                                    <Form.Control
                                                        as="textarea"
                                                        rows={3}
                                                        name="RECEPTION_CUM.assessor_comments"
                                                        value={values.RECEPTION_CUM.assessor_comments}
                                                        onChange={handleChange}
                                                        className={`form-control ${touched.RECEPTION_CUM?.assessor_comments &&
                                                            errors.RECEPTION_CUM?.assessor_comments
                                                            ? "is-invalid"
                                                            : ""
                                                            }`}
                                                    />
                                                    {touched.RECEPTION_CUM?.assessor_comments &&
                                                        errors.RECEPTION_CUM?.assessor_comments && (

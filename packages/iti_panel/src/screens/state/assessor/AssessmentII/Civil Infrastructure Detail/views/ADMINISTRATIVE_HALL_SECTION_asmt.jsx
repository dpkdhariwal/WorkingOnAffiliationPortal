                    ...
                    <Row style={{
                        ...
                        <Col xl={6} lg={6} md={6} sm={6}>
                            {values.usertype === C.SL.ASSESSOR && (
                                <Card ref={divRef} className="border border-2  card custom-card  card">
                                    <Card.Body>
                                        {info.replied === false && (<ViewArea required_area={info?.initial_detail?.required_area} totalAvailableArea={info?.initial_detail?.totalAvailableArea} document={info?.initial_detail?.document} />
                                        )}
                                        {info.replied === true && ("Latest")}
                                        {console.log(info)}
                                    </Card.Body>
                                </Card>
                            )}
                            ...
                            {/* INPUT */}
                            {values.ADMINISTRATIVE_HALL_SECTION.as_per_norms == C.SL.NO && values.usertype === C.SL.APPLICANT && (
                                <Card ref={divRef} className="border border-2  card custom-card  card">
                                    <Card.Body>
                                        <RevisedInputArea
                                            particular="ADMINISTRATIVE_HALL_SECTION"
                                            required_area={values?.ADMINISTRATIVE_HALL_SECTION?.initial_detail?.required_area}
                                            required_area_fieldname={`REVISED_ADMINISTRATIVE_HALL_SECTION.avaialble_area`}
                                            document_field={`REVISED_ADMINISTRATIVE_HALL_SECTION.document`}
                        ...
                        <Col xl={6} lg={6} md={6} sm={6}>
                            {values.usertype === C.SL.APPLICANT
                                && values.ADMINISTRATIVE_HALL_SECTION?.as_per_norms === "no" &&
                                (<ViewStateRemark title={`ADMINISTRATIVE_HALL_SECTION`}
                                    as_per_norms={values.ADMINISTRATIVE_HALL_SECTION?.as_per_norms}
                                    reason={values.ADMINISTRATIVE_HALL_SECTION?.reason}
                                    assessor_remark={values.ADMINISTRATIVE_HALL_SECTION?.assessor_remark} />)}
                                        ...
                                        <Form.Group>
                                            ...
                                            <div role="group" aria-labelledby="as_per_norms-group">
                                                <label className="me-3">
                                                    <Field
                                                        type="radio"
                                                        name="ADMINISTRATIVE_HALL_SECTION.as_per_norms"
                                                        value="yes"
                                    ...
                                    {values.ADMINISTRATIVE_HALL_SECTION.as_per_norms === "no" && (
                                        <Row className="mb-3">
                                            <Form.Group as={Col} md="12">
                                                ...
                                                <Field
                                                    name="ADMINISTRATIVE_HALL_SECTION.reason"
                                                    as="select"
                                            ...
                                            {values.ADMINISTRATIVE_HALL_SECTION.reason === "other" && (
                                                <Form.Group as={Col} md="12" style={{ marginTop: "1rem" }}>
                                                    ...
                                                    <Form.Control
                                                        as="textarea"
                                                        rows={3}
                                                        name="ADMINISTRATIVE_HALL_SECTION.assessor_comments"
                                                        value={values.ADMINISTRATIVE_HALL_SECTION.assessor_comments}
                                                        onChange={handleChange}
                                                        className={`form-control ${touched.ADMINISTRATIVE_HALL_SECTION?.assessor_comments &&
                                                            errors.ADMINISTRATIVE_HALL_SECTION?.assessor_comments
                                                            ? "is-invalid"
                                                            : ""
                                                            }`}
                                                    />
                                                    {touched.ADMINISTRATIVE_HALL_SECTION?.assessor_comments &&
                                                        errors.ADMINISTRATIVE_HALL_SECTION?.assessor_comments && (

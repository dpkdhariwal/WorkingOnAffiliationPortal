                    ...
                    <Row style={{
                        ...
                        <Col xl={6} lg={6} md={6} sm={6}>
                            {values.usertype === C.SL.ASSESSOR && (
                                <Card ref={divRef} className="border border-2  card custom-card  card">
                                    <Card.Body>
                                        {console.log(info)}
                                        {values.MULTIPURPOSE_HALL.replied === false && (<ViewArea required_area={info?.initial_detail?.required_area} totalAvailableArea={info?.initial_detail?.totalAvailableArea} document={info?.initial_detail?.document} />)}

                                        {values.MULTIPURPOSE_HALL.replied === true && ('Show Latest')}

                                    </Card.Body>
                                </Card>)}

                            {values.MULTIPURPOSE_HALL.as_per_norms == C.SL.NO && values.usertype === C.SL.APPLICANT && (
                                <Card ref={divRef} className="border border-2  card custom-card  card">
                                    <Card.Body>
                                        <RevisedInputArea
                                            particular="MULTIPURPOSE_HALL"
                                            required_area={values?.MULTIPURPOSE_HALL?.initial_detail?.required_area}
                                            required_area_fieldname={`REVISED_MULTIPURPOSE_HALL.avaialble_area`}
                                            document_field={`REVISED_MULTIPURPOSE_HALL.document`}
                        ...
                        <Col xl={6} lg={6} md={6} sm={6}>
                            ...
                            {values.usertype === C.SL.APPLICANT
                                && values.MULTIPURPOSE_HALL?.as_per_norms === "no" &&
                                (<ViewStateRemark title={`MULTIPURPOSE_HALL`}
                                    as_per_norms={values.MULTIPURPOSE_HALL?.as_per_norms}
                                    reason={values.MULTIPURPOSE_HALL?.reason}
                                    assessor_remark={values.MULTIPURPOSE_HALL?.assessor_remark} />)}
                                ...
                                <Card.Body>
                                        ...
                                        <Form.Group>
                                            ...
                                            <div role="group" aria-labelledby="as_per_norms-group">
                                                <label className="me-3">
                                                    <Field
                                                        type="radio"
                                                        name="MULTIPURPOSE_HALL.as_per_norms"
                                                        value="yes"
                                    ...
                                    {values.MULTIPURPOSE_HALL.as_per_norms === "no" && (
                                        <Row className="mb-3">
                                            ...
                                            {values.MULTIPURPOSE_HALL.reason === "other" && (
                                                <Form.Group as={Col} md="12" style={{ marginTop: "1rem" }}>
                                                    ...
                                                    <Form.Control
                                                        as="textarea"
                                                        rows={3}
                                                        name="MULTIPURPOSE_HALL.assessor_comments"
                                                        value={values.MULTIPURPOSE_HALL.assessor_comments}
                                                        onChange={handleChange}
                                                        className={`form-control ${touched.MULTIPURPOSE_HALL?.assessor_comments &&
                                                            errors.MULTIPURPOSE_HALL?.assessor_comments
                                                            ? "is-invalid"
                                                            : ""
                                                            }`}
                                                    />
                                                    {touched.MULTIPURPOSE_HALL?.assessor_comments &&
                                                        errors.MULTIPURPOSE_HALL?.assessor_comments && (

                    ...
                    <Row style={{
                        ...
                        <Col xl={6} lg={6} md={6} sm={6}>
                            {values.usertype === C.SL.ASSESSOR && (<Card ref={divRef} className="border border-2  card custom-card  card">
                                <Card.Body>
                                    {console.log(info)}
                                    {values.TRADE_DETAILS_BOARD.replied === false && (

                                        <DocumentPhoto FormContext={FormContext} particular={formatLabel('TRADE_DETAILS_BOARD')} documentUrl={values?.TRADE_DETAILS_BOARD?.initial_detail?.document} />
                                    )}

                                    {values.TRADE_DETAILS_BOARD.replied === true && (<DocumentPhoto FormContext={FormContext} particular={formatLabel('TRADE_DETAILS_BOARD')} documentUrl={values?.TRADE_DETAILS_BOARD?.initial_detail?.document} />)}

                                    {console.log(info)}
                                </Card.Body>
                            </Card>)}
                            {values.TRADE_DETAILS_BOARD.as_per_norms == C.SL.NO && values.usertype === C.SL.APPLICANT && (<Card ref={divRef} className="border border-2  card custom-card  card">
                                <Card.Body>
                                    <RevisedInputPhoto
                                        particular="TRADE_DETAILS_BOARD"
                                        document_field={`REVISED_TRADE_DETAILS_BOARD.document`}
                        ...
                        <Col xl={6} lg={6} md={6} sm={6}>
                            ...
                            {values.usertype === C.SL.APPLICANT
                                && values.TRADE_DETAILS_BOARD?.as_per_norms === "no" &&
                                (<ViewStateRemark title={`TRADE_DETAILS_BOARD`}
                                    as_per_norms={values.TRADE_DETAILS_BOARD?.as_per_norms}
                                    reason={values.TRADE_DETAILS_BOARD?.reason}
                                    assessor_remark={values.TRADE_DETAILS_BOARD?.assessor_remark} />)}
                                        ...
                                        <Form.Group>
                                            ...
                                            <div role="group" aria-labelledby="as_per_norms-group">
                                                <label className="me-3">
                                                    <Field
                                                        type="radio"
                                                        name="TRADE_DETAILS_BOARD.as_per_norms"
                                                        value="yes"
                                    ...
                                    {values.TRADE_DETAILS_BOARD.as_per_norms === "no" && (
                                        <Row className="mb-3">
                                            <Form.Group as={Col} md="12">
                                                ...
                                                <Field
                                                    name="TRADE_DETAILS_BOARD.reason"
                                                    as="select"
                                            ...
                                            {values.TRADE_DETAILS_BOARD.reason === "other" && (
                                                <Form.Group as={Col} md="12" style={{ marginTop: "1rem" }}>
                                                    ...
                                                    <Form.Control
                                                        as="textarea"
                                                        rows={3}
                                                        name="TRADE_DETAILS_BOARD.assessor_comments"
                                                        value={values.TRADE_DETAILS_BOARD.assessor_comments}
                                                        onChange={handleChange}
                                                        className={`form-control ${touched.TRADE_DETAILS_BOARD?.assessor_comments &&
                                                            errors.TRADE_DETAILS_BOARD?.assessor_comments
                                                            ? "is-invalid"
                                                            : ""
                                                            }`}
                                                    />
                                                    {touched.TRADE_DETAILS_BOARD?.assessor_comments &&
                                                        errors.TRADE_DETAILS_BOARD?.assessor_comments && (

    ...
    const setStepContent = (obj, index) => {
        ...
        switch (obj.keyName) {
            case C.iti_lab_particulars_keys.DESKTOP_COMPUTER_WITH_LATEST_CONFIGURATION.key:
                return <DESKTOP_COMPUTER_WITH_LATEST_CONFIGURATION title={obj.keyName} index={index} info={info} data={obj} FormContext={FormContext} />;
            ...
            //     return <OTHER_IT_LAB_PARTICULAR title={obj.keyName} index={index} info={info} data={obj} FormContext={FormContext}  />;
            //     break;
            default:
                return ''
        }

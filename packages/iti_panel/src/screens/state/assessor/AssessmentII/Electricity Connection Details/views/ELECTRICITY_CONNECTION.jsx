...
import { RevisedElectrityConnectionDetails } from "./revised_components/revised_electricity_connection_detail";
                        ...
                        <Col xl={6} lg={6} md={6} sm={6}>
                            {values.usertype === C.SL.ASSESSOR && (
                                <Card ref={divRef} className="border border-2  card custom-card  card">
                                    <Card.Body>
                                        {console.log(info)}
                                        {values.ELECTRICITY_CONNECTION.replied === false && (<Table bordered hover>
                                            <thead>
                                                <tr>
                                        ...
                                        {values.ELECTRICITY_CONNECTION.replied === true && ('Show Latest')}

                                        {console.log(info)}
                                    </Card.Body>
                                </Card>)}

                            {values.ELECTRICITY_CONNECTION.as_per_norms == C.SL.NO && values.usertype === C.SL.APPLICANT && (<Card ref={divRef} className="border border-2  card custom-card  card">
                                <Card.Body>
                                    <RevisedElectrityConnectionDetails FormContext={FormContext}/>
                                </Card.Body>
                            </Card>)}
                        </Col>
                        <Col xl={6} lg={6} md={6} sm={6}>
                            ...
                            {values.usertype === C.SL.APPLICANT
                                && values.ELECTRICITY_CONNECTION?.as_per_norms === "no" &&
                                (<ViewStateRemark title={`ELECTRICITY_CONNECTION`}
                                    as_per_norms={values.ELECTRICITY_CONNECTION?.as_per_norms}
                                    reason={values.ELECTRICITY_CONNECTION?.reason}
                                    assessor_remark={values.ELECTRICITY_CONNECTION?.assessor_remark} />)}
                                            ...
                                            <Form.Group>
                                                ...
                                                <div role="group" aria-labelledby="as_per_norms-group">
                                                    <label className="me-3">
                                                        <Field
                                                            type="radio"
                                                            name="ELECTRICITY_CONNECTION.as_per_norms"
                                                            value="yes"
                                        ...
                                        {values.ELECTRICITY_CONNECTION.as_per_norms === "no" && (
                                            <Row className="mb-3">
                                                <Form.Group as={Col} md="12">
                                                    ...
                                                    <Field
                                                        name="ELECTRICITY_CONNECTION.reason"
                                                        as="select"
                                                ...
                                                {values.ELECTRICITY_CONNECTION.reason === "other" && (
                                                    <Form.Group as={Col} md="12" style={{ marginTop: "1rem" }}>
                                                        ...
                                                        <Form.Control
                                                            as="textarea"
                                                            rows={3}
                                                            name="ELECTRICITY_CONNECTION.assessor_comments"
                                                            value={values.ELECTRICITY_CONNECTION.assessor_comments}
                                                            onChange={handleChange}
                                                            className={`form-control ${touched.ELECTRICITY_CONNECTION?.assessor_comments &&
                                                                errors.ELECTRICITY_CONNECTION?.assessor_comments
                                                                ? "is-invalid"
                                                                : ""
                                                                }`}
                                                        />
                                                        {touched.ELECTRICITY_CONNECTION?.assessor_comments &&
                                                            errors.ELECTRICITY_CONNECTION?.assessor_comments && (

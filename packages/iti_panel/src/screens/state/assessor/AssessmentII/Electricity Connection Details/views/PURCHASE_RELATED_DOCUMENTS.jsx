                    ...
                    <Row style={{
                        ...
                        <Col xl={6} lg={6} md={6} sm={6}>
                               {values.usertype === C.SL.ASSESSOR && (<Card ref={divRef} className="border border-2  card custom-card  card">
                                <Card.Body>
                                    {console.log(info)}
                                    {values.PURCHASE_RELATED_DOCUMENTS.replied === false && (<Table bordered hover>
                                        <thead>
                                            <tr>
                                     ...
                                     {values.PURCHASE_RELATED_DOCUMENTS.replied === true && ('Show Latest')}

                                    {console.log(info)}
                                </Card.Body>
                            </Card>)}

                             {values.PURCHASE_RELATED_DOCUMENTS.as_per_norms == C.SL.NO && values.usertype === C.SL.APPLICANT && (<Card ref={divRef} className="border border-2  card custom-card  card">
                                                            <Card.Body>
                                                                 <RevisedInputPhoto
                                        particular="PURCHASE_RELATED_DOCUMENTS"
                                        document_field={`REVISED_PURCHASE_RELATED_DOCUMENTS.document`}
                        ...
                        <Col xl={6} lg={6} md={6} sm={6}>
                            {/* style={{ height: `${height}px` }} */}
                              ...
                              {values.usertype === C.SL.APPLICANT
                                                            && values.PURCHASE_RELATED_DOCUMENTS?.as_per_norms === "no" &&
                                                            (<ViewStateRemark title={`PURCHASE_RELATED_DOCUMENTS`}
                                                                as_per_norms={values.PURCHASE_RELATED_DOCUMENTS?.as_per_norms}
                                                                reason={values.PURCHASE_RELATED_DOCUMENTS?.reason}
                                                                assessor_remark={values.PURCHASE_RELATED_DOCUMENTS?.assessor_remark} />)}
                                        ...
                                        <Form.Group>
                                            ...
                                            <div role="group" aria-labelledby="as_per_norms-group">
                                                <label className="me-3">
                                                    <Field
                                                        type="radio"
                                                        name="PURCHASE_RELATED_DOCUMENTS.as_per_norms"
                                                        value="yes"
                                    ...
                                    {values.PURCHASE_RELATED_DOCUMENTS.as_per_norms === "no" && (
                                        <Row className="mb-3">
                                            <Form.Group as={Col} md="12">
                                                ...
                                                <Field
                                                    name="PURCHASE_RELATED_DOCUMENTS.reason"
                                                    as="select"
                                            ...
                                            {values.PURCHASE_RELATED_DOCUMENTS.reason === "other" && (
                                                <Form.Group as={Col} md="12" style={{ marginTop: "1rem" }}>
                                                    ...
                                                    <Form.Control
                                                        as="textarea"
                                                        rows={3}
                                                        name="PURCHASE_RELATED_DOCUMENTS.assessor_comments"
                                                        value={values.PURCHASE_RELATED_DOCUMENTS.assessor_comments}
                                                        onChange={handleChange}
                                                        className={`form-control ${touched.PURCHASE_RELATED_DOCUMENTS?.assessor_comments &&
                                                            errors.PURCHASE_RELATED_DOCUMENTS?.assessor_comments
                                                            ? "is-invalid"
                                                            : ""
                                                            }`}
                                                    />
                                                    {touched.PURCHASE_RELATED_DOCUMENTS?.assessor_comments &&
                                                        errors.PURCHASE_RELATED_DOCUMENTS?.assessor_comments && (

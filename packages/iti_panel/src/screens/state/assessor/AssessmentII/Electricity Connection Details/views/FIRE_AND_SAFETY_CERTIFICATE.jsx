                    ...
                    <Row style={{
                        ...
                        <Col xl={6} lg={6} md={6} sm={6}>
                            {values.usertype === C.SL.ASSESSOR && (<Card ref={divRef} className="border border-2  card custom-card  card">
                                <Card.Body>
                                    {console.log(info)}
                                    {values.FIRE_AND_SAFETY_CERTIFICATE.replied === false && (<Table bordered hover>
                                        <thead>
                                            <tr>
                                    ...
                                    {values.FIRE_AND_SAFETY_CERTIFICATE.replied === true && ('Show Latest')}

                                    {console.log(info)}
                                </Card.Body>
                            </Card>)}

                            {values.FIRE_AND_SAFETY_CERTIFICATE.as_per_norms == C.SL.NO && values.usertype === C.SL.APPLICANT && (<Card ref={divRef} className="border border-2  card custom-card  card">
                                <Card.Body>
                                    <RevisedInputPhoto
                                        particular="FIRE_AND_SAFETY_CERTIFICATE"
                                        document_field={`REVISED_FIRE_AND_SAFETY_CERTIFICATE.document`}
                        ...
                        <Col xl={6} lg={6} md={6} sm={6}>
                            ...
                            {values.usertype === C.SL.APPLICANT
                                && values.FIRE_AND_SAFETY_CERTIFICATE?.as_per_norms === "no" &&
                                (<ViewStateRemark title={`FIRE_AND_SAFETY_CERTIFICATE`}
                                    as_per_norms={values.FIRE_AND_SAFETY_CERTIFICATE?.as_per_norms}
                                    reason={values.FIRE_AND_SAFETY_CERTIFICATE?.reason}
                                    assessor_remark={values.FIRE_AND_SAFETY_CERTIFICATE?.assessor_remark} />)}
                                        ...
                                        <Form.Group>
                                            ...
                                            <div role="group" aria-labelledby="as_per_norms-group">
                                                <label className="me-3">
                                                    <Field
                                                        type="radio"
                                                        name="FIRE_AND_SAFETY_CERTIFICATE.as_per_norms"
                                                        value="yes"
                                    ...
                                    {values.FIRE_AND_SAFETY_CERTIFICATE.as_per_norms === "no" && (
                                        <Row className="mb-3">
                                            <Form.Group as={Col} md="12">
                                                ...
                                                <Field
                                                    name="FIRE_AND_SAFETY_CERTIFICATE.reason"
                                                    as="select"
                                            ...
                                            {values.FIRE_AND_SAFETY_CERTIFICATE.reason === "other" && (
                                                <Form.Group as={Col} md="12" style={{ marginTop: "1rem" }}>
                                                    ...
                                                    <Form.Control
                                                        as="textarea"
                                                        rows={3}
                                                        name="FIRE_AND_SAFETY_CERTIFICATE.assessor_comments"
                                                        value={values.FIRE_AND_SAFETY_CERTIFICATE.assessor_comments}
                                                        onChange={handleChange}
                                                        className={`form-control ${touched.FIRE_AND_SAFETY_CERTIFICATE?.assessor_comments &&
                                                            errors.FIRE_AND_SAFETY_CERTIFICATE?.assessor_comments
                                                            ? "is-invalid"
                                                            : ""
                                                            }`}
                                                    />
                                                    {touched.FIRE_AND_SAFETY_CERTIFICATE?.assessor_comments &&
                                                        errors.FIRE_AND_SAFETY_CERTIFICATE?.assessor_comments && (

                    ...
                    <Row style={{
                        ...
                        <Col xl={6} lg={6} md={6} sm={6}>
                            {values.usertype === C.SL.ASSESSOR && (<Card ref={divRef} className="border border-2  card custom-card  card">
                                <Card.Body>
                                    {console.log(info)}
                                    {values.GENERAL_PARKING_DETAILS.replied === false && (<ViewArea required_area={info?.initial_detail?.required_area} totalAvailableArea={info?.initial_detail?.totalAvailableArea} />)}

                                    {values.GENERAL_PARKING_DETAILS.replied === true && ('Show Latest')}

                                    {console.log(info)}
                                </Card.Body>
                            </Card>)}

                            {values.GENERAL_PARKING_DETAILS.as_per_norms == C.SL.NO && values.usertype === C.SL.APPLICANT && (<Card ref={divRef} className="border border-2  card custom-card  card">
                                <Card.Body>
                                    <RevisedInputPhoto
                                        particular="GENERAL_PARKING_DETAILS"
                                        document_field={`REVISED_GENERAL_PARKING_DETAILS.document`}
                        ...
                        <Col xl={6} lg={6} md={6} sm={6}>
                            ...
                            {values.usertype === C.SL.APPLICANT
                                && values.GENERAL_PARKING_DETAILS?.as_per_norms === "no" &&
                                (<ViewStateRemark title={`GENERAL_PARKING_DETAILS`}
                                    as_per_norms={values.GENERAL_PARKING_DETAILS?.as_per_norms}
                                    reason={values.GENERAL_PARKING_DETAILS?.reason}
                                    assessor_remark={values.GENERAL_PARKING_DETAILS?.assessor_remark} />)}
                                        ...
                                        <Form.Group>
                                            ...
                                            <div role="group" aria-labelledby="as_per_norms-group">
                                                <label className="me-3">
                                                    <Field
                                                        type="radio"
                                                        name="GENERAL_PARKING_DETAILS.as_per_norms"
                                                        value="yes"
                                    ...
                                    {values.GENERAL_PARKING_DETAILS.as_per_norms === "no" && (
                                        <Row className="mb-3">
                                            <Form.Group as={Col} md="12">
                                                ...
                                                <Field
                                                    name="GENERAL_PARKING_DETAILS.reason"
                                                    as="select"
                                            ...
                                            {values.GENERAL_PARKING_DETAILS.reason === "other" && (
                                                <Form.Group as={Col} md="12" style={{ marginTop: "1rem" }}>
                                                    ...
                                                    <Form.Control
                                                        as="textarea"
                                                        rows={3}
                                                        name="GENERAL_PARKING_DETAILS.assessor_comments"
                                                        value={values.GENERAL_PARKING_DETAILS.assessor_comments}
                                                        onChange={handleChange}
                                                        className={`form-control ${touched.GENERAL_PARKING_DETAILS?.assessor_comments &&
                                                            errors.GENERAL_PARKING_DETAILS?.assessor_comments
                                                            ? "is-invalid"
                                                            : ""
                                                            }`}
                                                    />
                                                    {touched.GENERAL_PARKING_DETAILS?.assessor_comments &&
                                                        errors.GENERAL_PARKING_DETAILS?.assessor_comments && (

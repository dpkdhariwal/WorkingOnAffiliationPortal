                    ...
                    <Row style={{
                        ...
                        <Col xl={6} lg={6} md={6} sm={6}>
                            {values.usertype === C.SL.ASSESSOR && (<Card ref={divRef} className="border border-2  card custom-card  card">
                                <Card.Body>
                                    {console.log(info)}
                                    {values.LIBRARY_AND_READING_ROOM.replied === false && (<ViewArea required_area={info?.initial_detail?.required_area} totalAvailableArea={info?.initial_detail?.totalAvailableArea} />)}

                                    {values.LIBRARY_AND_READING_ROOM.replied === true && ('Show Latest')}

                                    {console.log(info)}
                                </Card.Body>
                            </Card>)}

                            {values.LIBRARY_AND_READING_ROOM.as_per_norms == C.SL.NO && values.usertype === C.SL.APPLICANT && (<Card ref={divRef} className="border border-2  card custom-card  card">
                                <Card.Body>
                                    <RevisedInputArea
                                        particular="LIBRARY_AND_READING_ROOM"
                                        required_area={values?.LIBRARY_AND_READING_ROOM?.initial_detail?.required_area}
                                        required_area_fieldname={`REVISED_LIBRARY_AND_READING_ROOM.avaialble_area`}
                                        document_field={`REVISED_LIBRARY_AND_READING_ROOM.document`}
                        ...
                        <Col xl={6} lg={6} md={6} sm={6}>
                            ...
                            {values.usertype === C.SL.APPLICANT
                                && values.LIBRARY_AND_READING_ROOM?.as_per_norms === "no" &&
                                (<ViewStateRemark title={`LIBRARY_AND_READING_ROOM`}
                                    as_per_norms={values.LIBRARY_AND_READING_ROOM?.as_per_norms}
                                    reason={values.LIBRARY_AND_READING_ROOM?.reason}
                                    assessor_remark={values.LIBRARY_AND_READING_ROOM?.assessor_remark} />)}
                                        ...
                                        <Form.Group>
                                            ...
                                            <div role="group" aria-labelledby="as_per_norms-group">
                                                <label className="me-3">
                                                    <Field
                                                        type="radio"
                                                        name="LIBRARY_AND_READING_ROOM.as_per_norms"
                                                        value="yes"
                                    ...
                                    {values.LIBRARY_AND_READING_ROOM.as_per_norms === "no" && (
                                        <Row className="mb-3">
                                            <Form.Group as={Col} md="12">
                                                ...
                                                <Field
                                                    name="LIBRARY_AND_READING_ROOM.reason"
                                                    as="select"
                                            ...
                                            {values.LIBRARY_AND_READING_ROOM.reason === "other" && (
                                                <Form.Group as={Col} md="12" style={{ marginTop: "1rem" }}>
                                                    ...
                                                    <Form.Control
                                                        as="textarea"
                                                        rows={3}
                                                        name="LIBRARY_AND_READING_ROOM.assessor_comments"
                                                        value={values.LIBRARY_AND_READING_ROOM.assessor_comments}
                                                        onChange={handleChange}
                                                        className={`form-control ${touched.LIBRARY_AND_READING_ROOM?.assessor_comments &&
                                                            errors.LIBRARY_AND_READING_ROOM?.assessor_comments
                                                            ? "is-invalid"
                                                            : ""
                                                            }`}
                                                    />
                                                    {touched.LIBRARY_AND_READING_ROOM?.assessor_comments &&
                                                        errors.LIBRARY_AND_READING_ROOM?.assessor_comments && (

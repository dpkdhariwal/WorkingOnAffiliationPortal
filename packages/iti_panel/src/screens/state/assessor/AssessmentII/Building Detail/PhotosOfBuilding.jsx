...
//     );
// };
export const PhotosOfBuilding = ({ info, FormContext }) => {
                    ...
                    <Row style={{
                        ...
                        <Col xl={8} lg={8} md={8} sm={8}>
                            {values.usertype === C.SL.ASSESSOR && (<Card ref={divRef} className="border border-2  card custom-card  card">
                                <Card.Body>
                                    {values.building_photos.replied === false && (
                                        <Table bordered hover>
                                            <thead>
                                                <tr>
                                                    {/* <th>as per norms?</th> */}
                                    ...
                                    {values.building_photos.replied === true && (
                                        'Show Latest'
                                    )}
                            ...
                            {/* INPUT FOR APPLICANT */}
                            {values.building_photos.as_per_norms == C.SL.NO && values.usertype === C.SL.APPLICANT && (
                        ...
                        <Col xl={4} lg={4} md={4} sm={4}>
                            {values.usertype === C.SL.APPLICANT
                                ...
                                (<ViewStateRemark title="Building Completion Certificate"
                                    as_per_norms={values.building_photos?.as_per_norms}
                                    reason={values.building_photos?.reason}
                                    assessor_remark={values.building_photos?.assessor_remark} />)}

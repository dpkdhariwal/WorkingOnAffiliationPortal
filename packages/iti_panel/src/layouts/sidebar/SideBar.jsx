			...
			<aside className="app-sidebar sticky" id="sidebar" onMouseEnter={() => Onhover()} onMouseLeave={() => Outhover()}>
				<div className="main-sidebar-header">
					<Link to={`${import.meta.env.BASE_URL}dashboard/dashboard/`} className="header-logo">
						<img src={ALLImages('logo3')} className="desktop-white" alt="logo1" />
						<img src={ALLImages('logo6')} className="toggle-white" alt="logo2" />
						<img src={ALLImages('logo2')} className="desktop-logo" alt="logo3" />
						<img src={ALLImages('logo4')} className="toggle-dark" alt="logo4" />
						<img src={ALLImages('logo5')} className="toggle-logo" alt="logo5" />
						<img src={ALLImages('logo1')} className="desktop-dark" alt="logo6" />
					</Link>
				</div>
							...
							{MENUITEMS.map((levelone) => (
								<Fragment key={Math.random()}>
									<li className={`${levelone.menutitle ? 'slide__category' : ''} 
													...
													localStorage.spruhaverticalstyles === 'doublemenu' ? (
														...
														<>
															...
															<div className="custom-tooltip">
																<OverlayTrigger placement={localStorage.spruhartl ? 'left' : 'right'} overlay={<Tooltip>{levelone.title}</Tooltip>}>
																	<i className={`${levelone.icon} side-menu__icon`}></i>
																</OverlayTrigger>
															</div>
														</>
										...
										{/* if empty  */}
										{levelone.type === "empty" ?
											<Link to="#" className='side-menu__item'><i className={`${levelone.icon} side-menu__icon`}></i><span className="">{levelone.title}</span></Link>
											: ""}
